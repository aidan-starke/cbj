...
contract('House', accounts => {
    ...
    describe('createBag', () => {
        ...
        it('should create bag', async () => {
            ...
            let value = Number(bagPrice.toString()) + Number(chipPrice.toString()) * 1000
            value = value.toString()

            await house.createBag(bagAddress, 1, 1000, { value: value, gas: 1000000 })
        ...
        it('should not create bag if value of transaction is below value of bag + chips', async () => {
            await expectRevert(
                house.createBag(bagAddress, 1, 1000, { value: 0, gas: 1000000 }),
    ...
    describe('buyChips', () => {
        it('should buy chips', async () => {
            ...
            assert(chipBalance.toString() === '2000')
        })
